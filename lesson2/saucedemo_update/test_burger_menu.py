...
from locators import (LOGOUT_SIDEBAR_LINK, LOGIN_LOGO_TEXT, ABOUT_SIDEBAR_LINK,
                      INVENTORY_ADD_SAUCE_LABS_BACKPACK_BUTTON, HEADER_SHOPPING_CART_LINK, ALL_CART_ITEMS,
...
def test_remove_product_from_cart_on_product_card_page(driver, login):
    ...
    time.sleep(1)
    link_to_open_cart = driver.find_element(By.XPATH, HEADER_SHOPPING_CART_LINK)
